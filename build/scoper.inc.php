...
use PC_Headless_Blog_1AA\Isolated\Symfony\Component\Finder\Finder;
...
return array(
    ...
    'finders' => array(\PC_Headless_Blog_1AA\Isolated\Symfony\Component\Finder\Finder::create()->files()->ignoreVCS(\true)->notName('/LICENSE|.*\\.md|.*\\.dist|Makefile|composer\\.json|composer\\.lock/')->exclude(array('doc', 'vendor-bin'))->in('vendor'), \PC_Headless_Blog_1AA\Isolated\Symfony\Component\Finder\Finder::create()->append(array('composer.json'))),
    ...
    'whitelist' => array('PHPUnit\\Framework\\*', 'PC_Headless_Blog_1AA\\Composer\\Autoload\\ClassLoader', 'PinkCrab\\Headless_Blog\\*'),
