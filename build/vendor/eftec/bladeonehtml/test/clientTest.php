...
class clientTest extends \PHPUnit\Framework\TestCase
{
    ...
    function setUp()
    {
        $this->myBlade = new \PC_Headless_Blog_1AA\eftec\tests\myBlade();
        $this->myBlade->setMode(\PC_Headless_Blog_1AA\eftec\bladeone\BladeOne::MODE_DEBUG);
    }
