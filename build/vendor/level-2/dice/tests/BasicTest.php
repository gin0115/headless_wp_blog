 ...
 * @version 3.0 */
class BasicTest extends \PC_Headless_Blog_1AA\DiceTest
{
    ...
    public function testSharedOverride()
    {
        ...
        $dice = $this->dice->addRule('*', ['shared' => \true]);
    ...
    public function testPassGlobals()
    {
        ...
        $_GET['foo'] = 'bar';
        $dice = $this->dice->addRule('CheckConstructorArgs', ['constructParams' => [[\PC_Headless_Blog_1AA\Dice\Dice::GLOBAL => '_GET']]]);
        $obj = $dice->create('CheckConstructorArgs');
        $this->assertEquals($_GET, $obj->arg1);
    }
    public function testPassConstantString()
    {
        $dice = $this->dice->addRule('CheckConstructorArgs', ['constructParams' => [[\PC_Headless_Blog_1AA\Dice\Dice::CONSTANT => '\\PDO::FETCH_ASSOC']]]);
        $obj = $dice->create('CheckConstructorArgs');
    ...
    public function testImmutability()
    {
        ...
        $dice = $this->dice->addRule('Foo', ['shared' => \true]);
        $this->assertEquals([], $this->dice->getRule('Foo'));
    }
    public function testPassSelf()
    {
        $dice = $this->dice->addRule('CheckConstructorArgs', ['constructParams' => [[\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => \PC_Headless_Blog_1AA\Dice\Dice::SELF]]]);
        $obj = $dice->create('CheckConstructorArgs');
 ...
 * @license http:// www.opensource.org/licenses/bsd-license.php BSD License *
 * @version 3.0 */
\class_alias('PC_Headless_Blog_1AA\\BasicTest', 'BasicTest', \false);
