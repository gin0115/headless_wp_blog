 ...
 * @version 3.0 */
class CallTest extends \PC_Headless_Blog_1AA\DiceTest
{
    ...
    {
        $rule = [];
        $rule['call'][] = array('callMe', array([\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => 'A']));
    ...
    {
        $rules = ['TestCallImmutable' => ['call' => [['call1', ['foo'], \PC_Headless_Blog_1AA\Dice\Dice::CHAIN_CALL], ['call2', ['bar'], \PC_Headless_Blog_1AA\Dice\Dice::CHAIN_CALL]]]];
    ...
    public function testCallShareVariadic()
    {
        ...
        $dice = $this->dice->addRules($rules);
        $object = $dice->create('TestCallVariadic', [], [new \PC_Headless_Blog_1AA\F()]);
 ...
 * @license http:// www.opensource.org/licenses/bsd-license.php BSD License *
 * @version 3.0 */
\class_alias('PC_Headless_Blog_1AA\\CallTest', 'CallTest', \false);
