 ...
 * @version 3.0 */
class ConstructParamsTest extends \PC_Headless_Blog_1AA\DiceTest
{
    ...
    {
        $rule = [];
        $rule['constructParams'] = [[\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => 'A'], null];
 ...
 * @license http:// www.opensource.org/licenses/bsd-license.php BSD License *
 * @version 3.0 */
\class_alias('PC_Headless_Blog_1AA\\ConstructParamsTest', 'ConstructParamsTest', \false);
