 ...
 * @version 3.0 */
class NamedInstancesTest extends \PC_Headless_Blog_1AA\DiceTest
{
    public function testMultipleSharedInstancesByNameMixed()
    {
        ...
        $rule = [];
        $rule['constructParams'] = [[\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => 'Y'], [\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '[Y2]']];
    ...
    public function testNonSharedComponentByNameA()
    {
        ...
        $rule = [];
        $rule['constructParams'][] = [\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '$B'];
    ...
    public function testNonSharedComponentByName()
    {
        ...
        $rule = [];
        $rule['constructParams'][] = [\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '$Y2'];
    ...
    public function testSubstitutionByName()
    {
        ...
        $dice = $this->dice->addRule('$B', $rule);
        $rule = [];
        $rule['substitutions']['B'] = [\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '$B'];
        $dice = $dice->addRule('A', $rule);
        $a = $dice->create('A');
        $this->assertInstanceOf('ExtendedB', $a->b);
    }
    public function testMultipleSubstitutions()
    {
        ...
        $rule = [];
        $rule['constructParams'] = array([\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '$Y2A'], [\PC_Headless_Blog_1AA\Dice\Dice::INSTANCE => '$Y2B']);
 ...
 * @license http:// www.opensource.org/licenses/bsd-license.php BSD License *
 * @version 3.0 */
\class_alias('PC_Headless_Blog_1AA\\NamedInstancesTest', 'NamedInstancesTest', \false);
