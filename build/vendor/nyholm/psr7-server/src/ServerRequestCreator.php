...
namespace PC_Headless_Blog_1AA\Nyholm\Psr7Server;
 ...
 */
final class ServerRequestCreator implements \PC_Headless_Blog_1AA\Nyholm\Psr7Server\ServerRequestCreatorInterface
{
    private $serverRequestFactory;
    private $uriFactory;
    private $uploadedFileFactory;
    private $streamFactory;
    public function __construct(\PC_Headless_Blog_1AA\Psr\Http\Message\ServerRequestFactoryInterface $serverRequestFactory, \PC_Headless_Blog_1AA\Psr\Http\Message\UriFactoryInterface $uriFactory, \PC_Headless_Blog_1AA\Psr\Http\Message\UploadedFileFactoryInterface $uploadedFileFactory, \PC_Headless_Blog_1AA\Psr\Http\Message\StreamFactoryInterface $streamFactory)
    {
     ...
     * {@inheritdoc}
     */
    public function fromGlobals() : \PC_Headless_Blog_1AA\Psr\Http\Message\ServerRequestInterface
    {
        $server = $_SERVER;
     ...
     * {@inheritdoc}
     */
    public function fromArrays(array $server, array $headers = [], array $cookie = [], array $get = [], ?array $post = null, array $files = [], $body = null) : \PC_Headless_Blog_1AA\Psr\Http\Message\ServerRequestInterface
    {
        ...
        } elseif (!$body instanceof \PC_Headless_Blog_1AA\Psr\Http\Message\StreamInterface) {
    ...
    private function getUriFromEnvWithHTTP(array $environment) : \PC_Headless_Blog_1AA\Psr\Http\Message\UriInterface
    {
    ...
    private function normalizeFiles(array $files) : array
    {
        ...
        foreach ($files as $key => $value) {
            if ($value instanceof \PC_Headless_Blog_1AA\Psr\Http\Message\UploadedFileInterface) {
     ...
     */
    private function createUriFromArray(array $server) : \PC_Headless_Blog_1AA\Psr\Http\Message\UriInterface
    {
