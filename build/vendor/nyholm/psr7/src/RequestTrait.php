...
trait RequestTrait
{
    ...
    public function getUri() : \PC_Headless_Blog_1AA\Psr\Http\Message\UriInterface
    {
        return $this->uri;
    }
    public function withUri(\PC_Headless_Blog_1AA\Psr\Http\Message\UriInterface $uri, $preserveHost = \false) : self
    {
        if ($uri === $this->uri) {
            return $this;
        }
