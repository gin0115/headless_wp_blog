 ...
 */
class ServerRequest implements \PC_Headless_Blog_1AA\Psr\Http\Message\ServerRequestInterface
{
    use MessageTrait;
    use RequestTrait;
    /** @var array */
    ...
    public function __construct(string $method, $uri, array $headers = [], $body = null, string $version = '1.1', array $serverParams = [])
    {
        ...
        if (!$uri instanceof \PC_Headless_Blog_1AA\Psr\Http\Message\UriInterface) {
            $uri = new \PC_Headless_Blog_1AA\Nyholm\Psr7\Uri($uri);
        }
        $this->method = $method;
        $this->uri = $uri;
        ...
        if ('' !== $body && null !== $body) {
            $this->stream = \PC_Headless_Blog_1AA\Nyholm\Psr7\Stream::create($body);
        }
    }
