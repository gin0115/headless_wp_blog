...
use PC_Headless_Blog_1AA\Symfony\Component\Debug\ErrorHandler as SymfonyLegacyErrorHandler;
use PC_Headless_Blog_1AA\Symfony\Component\ErrorHandler\ErrorHandler as SymfonyErrorHandler;
/**
 ...
 */
class Stream implements \PC_Headless_Blog_1AA\Psr\Http\Message\StreamInterface
{
     ...
     */
    public static function create($body = '') : \PC_Headless_Blog_1AA\Psr\Http\Message\StreamInterface
    {
        if ($body instanceof \PC_Headless_Blog_1AA\Psr\Http\Message\StreamInterface) {
            return $body;
        }
        if (\is_string($body)) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($e instanceof \Error || $errorHandler instanceof \PC_Headless_Blog_1AA\Symfony\Component\ErrorHandler\ErrorHandler || $errorHandler instanceof \PC_Headless_Blog_1AA\Symfony\Component\Debug\ErrorHandler) {
