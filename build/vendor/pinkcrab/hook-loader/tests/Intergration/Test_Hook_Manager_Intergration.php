 ...
 */
namespace PC_Headless_Blog_1AA\PinkCrab\Loader\Tests\Intergration;

use PC_Headless_Blog_1AA\WP_UnitTestCase;
use PC_Headless_Blog_1AA\PinkCrab\Loader\Hook;
use PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Loader;
use PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager;
use PC_Headless_Blog_1AA\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock;
use PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception;
class Test_Hook_Manager_Intergration extends \WP_UnitTestCase
{
    ...
    {
        // Hooks
        $global = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('global', 'is_string');
        $admin = (new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('admin', 'is_string'))->front(\false);
        // Front & Admin true by default.
        $front = (new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('front', 'is_string'))->admin(\false);
        // Front
        $manager_front = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
        ...
        $manager_admin = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
    ...
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_action', 'is_string');
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_action', 'no_Callback_HERE');
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_filter', 'is_string');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::FILTER);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    ...
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_filter', 'no_Callback_HERE');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::FILTER);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    public function test_can_remove_hook() : void
    {
        ...
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('remove_me_action', 'is_string');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::REMOVE);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    ...
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('remove_me_action', 'no_Callback_HERE');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::REMOVE);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook_both = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_ajax_both', 'is_string');
        $hook_both->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_ajax_public', 'is_string');
        $hook_public_only->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only->ajax_private(\false);
        $hook_private_only = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_ajax_private', 'is_string');
        $hook_private_only->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
        $hook_private_only->ajax_public(\false);
        $hook_neither = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_ajax_neither', 'is_string');
        $hook_neither->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
    ...
    public function test_throws_exception_with_invlalid_ajax_callback() : void
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('remove_me_action', 'no_Callback_HERE');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $shortcode = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_shortcode', 'is_string');
        $shortcode->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::SHORTCODE);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_shortcode', 'no_Callback_HERE');
        $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::SHORTCODE);
        $manager = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $loader = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook_Loader();
