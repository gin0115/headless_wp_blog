...
class Test_Hook extends \PHPUnit\Framework\TestCase
{
    public function test_can_create_base_model_with_constructor()
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_action', 'is_int', 999, 2);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::ACTION, $hook->get_type());
        ...
        // Check defaults.
        $hook_default = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('my_filter', 'is_string');
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::ACTION, $hook_default->get_type());
    ...
    public function test_can_set_type() : void
    {
        ...
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::ACTION, $hook->get_type());
        $hook_filter = $hook->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::FILTER);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::FILTER, $hook_filter->get_type());
        $hook_ajax = $hook_filter->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::AJAX, $hook_ajax->get_type());
        $hook_shortcode = $hook_ajax->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::SHORTCODE);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::SHORTCODE, $hook_shortcode->get_type());
        $hook_action = $hook_shortcode->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::ACTION);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::ACTION, $hook_action->get_type());
        $hook_remove = $hook_action->type(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::REMOVE);
        $this->assertEquals(\PC_Headless_Blog_1AA\PinkCrab\Loader\Hook::REMOVE, $hook_remove->get_type());
    }
    /** @testdox Can modify and get the hooks handle */
    public function test_handle_methods() : void
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('empty', 'is_string');
        $hook->handle('test');
    ...
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('foo', 'is_bool');
    ...
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('foo', 'is_bool', 42);
        $hook->priority(420);
    ...
    {
        $hook = new \PC_Headless_Blog_1AA\PinkCrab\Loader\Hook('foo', 'is_bool', 42, 1);
        $hook->args(2);
        $this->assertEquals(2, $hook->args_count());
    }
