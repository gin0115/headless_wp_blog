 ...
 */
class Test_HTTP extends \PC_Headless_Blog_1AA\Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    /**
    ...
    public function test_headers_with_json() : void
    {
        ...
        $mock_header = array();
        $mock_header = (new \PC_Headless_Blog_1AA\PinkCrab\HTTP\HTTP())->headers_with_json($mock_header);
        ...
        $mock_header2 = (new \PC_Headless_Blog_1AA\PinkCrab\HTTP\HTTP())->headers_with_json($mock_header2);
 ...
 * @preserdveGlobalState disabled
 */
\class_alias('PC_Headless_Blog_1AA\\Test_HTTP', 'Test_HTTP', \false);
