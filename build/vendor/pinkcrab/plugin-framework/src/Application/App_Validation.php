...
class App_Validation
{
     ...
     */
    protected $required_properties = array('container' => \true, 'app_config' => \true, 'registration' => \false, 'loader' => \false);
    /** @var array<string> */
    public $errors = array();
    /** @var App */
    protected $app;
    ...
    protected function validate_properties_set() : void
    {
        foreach ($this->required_properties as $property => $is_static) {
            ...
            $property_reflection->setAccessible(\true);
