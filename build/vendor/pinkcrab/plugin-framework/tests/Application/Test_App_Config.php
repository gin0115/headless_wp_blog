...
class Test_App_Config extends \WP_UnitTestCase
{
     ...
     */
    public const SAMPLE_SETTINGS = array('additional' => array('array' => array(1, 2, 3, 4), 'string' => 'HI'), 'namespaces' => array('rest' => 'fake_rest'), 'post_types' => array('my_cpt' => array(
        // Allows expressions for values.
        'slug' => 'my_slug',
        'meta' => array('meta_1' => 'value_1'),
    )), 'taxonomies' => array('tax' => array(
        // Allows expressions for values.
        'slug' => 'my_slug',
        'term' => array('term_1' => 'value_1'),
    ...
    public function test_can_create() : void
    {
        ...
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config::class, new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(self::SAMPLE_SETTINGS));
        // Without additional settings
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config::class, new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config());
    }
    /**
    ...
    {
        $this->assertTrue(\is_string(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Config::namespace('rest')));
        $this->assertTrue(\is_array(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Config::path()));
        $this->assertTrue(\is_array(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Config::url()));
    }
    /**
    ...
    {
        $app_config = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(self::SAMPLE_SETTINGS);
    ...
    {
        $no_override = \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::make(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config::class);
        $with_override = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(self::SAMPLE_SETTINGS);
        $this->assertNotEquals($no_override->namespace('rest'), $with_override->namespace('rest'));
    }
    /**
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(array('post_types' => array('cpt' => array('_slug' => 'failue'))));
    }
    /**
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(array('post_types' => array('cpt' => array('slug' => 'my_cpt', '_meta' => 'failue'))));
    }
    /**
     *                                 TAXONMIES
     */
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(array('taxonomies' => array('cpt' => array('_slug' => 'failue'))));
    }
    /**
     * Test throws exception for missing cpt meta.
     *
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config(array('taxonomies' => array('cpt' => array('slug' => 'my_cpt', '_meta' => 'failue'))));
    }
    /**
