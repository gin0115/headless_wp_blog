...
class Test_App_Functional extends \WP_UnitTestCase
{
    ...
    public function test_all_hooks_fire_on_finalise_during_boot() : void
    {
        ...
        \add_action(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_PRE_BOOT, function (\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config $config, \PC_Headless_Blog_1AA\PinkCrab\Loader\Loader $loader, \PC_Headless_Blog_1AA\PinkCrab\Core\Interfaces\DI_Container $container) {
            echo 'Pre Boot Hook';
        }, 10, 3);
        // Pre registration hook.
        $this->expectOutputRegex('/Pre Registration Hook/');
        \add_action(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_PRE_REGISTRATION, function (\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config $config, \PC_Headless_Blog_1AA\PinkCrab\Loader\Loader $loader, \PC_Headless_Blog_1AA\PinkCrab\Core\Interfaces\DI_Container $container) {
            echo 'Pre Registration Hook';
        }, 10, 3);
        // Post registration.
        $this->expectOutputRegex('/Post Registration Hook/');
        \add_action(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_POST_REGISTRATION, function (\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config $config, \PC_Headless_Blog_1AA\PinkCrab\Loader\Loader $loader, \PC_Headless_Blog_1AA\PinkCrab\Core\Interfaces\DI_Container $container) {
        ...
        do_action('init');
        // Cleanup
        remove_all_actions(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_PRE_BOOT);
        remove_all_actions(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_PRE_REGISTRATION);
        remove_all_actions(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\Hooks::APP_INIT_POST_REGISTRATION);
    }
    ...
    public function test_can_use_static_make_method_to_use_di_container() : void
    {
        ...
        $parent = \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::make(\PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Parent_Dependency::class);
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Parent_Dependency::class, $parent);
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Sample_Class::class, $parent->get_sample_class());
    }
    ...
    public function test_cant_use_make_before_app_booted() : void
    {
        ...
        \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::make(\PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Parent_Dependency::class);
    }
    ...
    {
        $app = $this->pre_populated_app_provider()->boot();
        $version = \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::config('version');
    ...
    public function test_cant_use_config_before_app_has_been_booted() : void
    {
        $this->expectException(\PC_Headless_Blog_1AA\PinkCrab\Core\Exceptions\App_Initialization_Exception::class);
        $this->expectExceptionCode(4);
        \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::config('version');
    }
    ...
    public function test_can_user_static_view_from_app_once_booted() : void
    {
        $app = $this->pre_populated_app_provider()->container_config(function ($di) {
            $di->addRules(['*' => array('substitutions' => array(\PC_Headless_Blog_1AA\PinkCrab\Core\Interfaces\Renderable::class => new \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\PHP_Engine(FIXTURES_PATH . '/Views')))]);
        })->boot();
        $this->expectOutputString('HI');
        \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App::view()->render('hello', ['hello' => 'HI']);
    }
    ...
    public function test_debugInfo_dumps_static_properties_values() : void
    {
        ...
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Interfaces\DI_Container::class, $debug['container']);
        $this->assertArrayHasKey('app_config', $debug);
        $this->assertInstanceOf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Config::class, $debug['app_config']);
