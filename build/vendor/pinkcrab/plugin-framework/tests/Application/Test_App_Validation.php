...
use PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation;
...
class Test_App_Validation extends \WP_UnitTestCase
{
    ...
    public function test_validation_failed_with_no_container() : void
    {
        ...
        $validator = new \PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation($app);
        $validator->validate();
        $this->assertNotEmpty($validator->errors);
        $this->assertContains(\sprintf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation::ERROR_MESSAGE_TEMPLATE, 'container'), $validator->errors);
    }
    ...
    public function test_validation_failed_with_no_loader() : void
    {
        ...
        $validator->validate();
        $this->assertNotEmpty($validator->errors);
        $this->assertContains(\sprintf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation::ERROR_MESSAGE_TEMPLATE, 'loader'), $validator->errors);
    }
    ...
    public function test_validation_failed_with_no_app_config() : void
    {
        ...
        $validator->validate();
        $this->assertNotEmpty($validator->errors);
        $this->assertContains(\sprintf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation::ERROR_MESSAGE_TEMPLATE, 'app_config'), $validator->errors);
    }
    ...
    public function test_validation_failed_with_no_registration() : void
    {
        ...
        $validator->validate();
        $this->assertNotEmpty($validator->errors);
        $this->assertContains(\sprintf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation::ERROR_MESSAGE_TEMPLATE, 'registration'), $validator->errors);
    }
    ...
    public function test_alread_booted_app_fails_validataion() : void
    {
        ...
        $validator->validate();
        $this->assertNotEmpty($validator->errors);
        $this->assertContains(\sprintf(\PC_Headless_Blog_1AA\PinkCrab\Core\Application\App_Validation::ERROR_MESSAGE_APP_BOOTED, 'registration'), $validator->errors);
    }
}
