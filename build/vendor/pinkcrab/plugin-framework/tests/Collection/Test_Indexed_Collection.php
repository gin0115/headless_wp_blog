...
use PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Indexed_Collection;
class Test_Indexed_Collection_Trait extends \WP_UnitTestCase
{
    ...
    {
        $collection = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Indexed_Collection(array('a' => 1, 'b' => 2));
    ...
    {
        $collection = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Indexed_Collection(array('a' => 1, 'b' => 2, 'c' => 1, 'd' => 1));
        ...
        $collection_objects = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Indexed_Collection(array('a' => $obj_a, 'b' => $obj_b, 'c' => $obj_a));
    ...
    {
        $collection = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Indexed_Collection(array('a' => 1, 'b' => 2, 'c' => 3, 'd' => 4));
