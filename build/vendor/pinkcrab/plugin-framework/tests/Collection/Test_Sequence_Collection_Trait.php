...
use PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Sequence_Collection;
class Test_Sequence_Collection_Trait extends \WP_UnitTestCase
{
    ...
    {
        $collection = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Sequence_Collection(array(1, 2, 3, 4, 5));
        $collection->reverse();
    ...
    public function test_throws_if_getting_first_of_empty_collection() : void
    {
        ...
        $collection = \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Sequence_Collection::from(array());
        $collection->first();
    }
    /**
    ...
    {
        $collection = new \PC_Headless_Blog_1AA\PinkCrab\Core\Tests\Fixtures\Mock_Objects\Sequence_Collection(array(1, 'tree', '2', 5, 9.9));
