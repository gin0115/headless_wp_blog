...
class Test_PHP_Engine extends \WP_UnitTestCase
{
    ...
    {
        parent::setUp();
        $this->view = new \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\PHP_Engine(\dirname(__DIR__, 1) . '/Fixtures/Views/');
    }
    /**
    ...
    {
        $this->assertEquals('Hello World', $this->view->render('hello', array('hello' => 'Hello World'), \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\View::RETURN_VIEW));
    }
    /**
    ...
    public function test_print_partial_template() : void
    {
        ...
        $this->view->render('layout', array('partial_data' => array('partial' => 'partial_value')), \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\View::PRINT_VIEW);
    }
    /**
    ...
    {
        $this->expectOutputString('partial_value');
        $this->view->render('returns_partial', array('partial_data' => array('partial' => 'partial_value')), \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\View::PRINT_VIEW);
    }
    /**
     * Test can return the view as a string.
     *
    ...
    {
        $this->assertEquals('partial_value', $this->view->render('layout', array('partial_data' => array('partial' => 'partial_value')), \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\View::RETURN_VIEW));
    }
    /**
    ...
    {
        $this->expectException(\Exception::class);
        new \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\PHP_Engine(\dirname(__DIR__, 1) . '/Fixtures/Fake_Views/');
    }
    /**
    ...
    {
        $this->expectOutputString('Hello World');
        $view = new \PC_Headless_Blog_1AA\PinkCrab\Core\Services\View\PHP_Engine(\dirname(__DIR__, 1) . '/Fixtures/Views');
