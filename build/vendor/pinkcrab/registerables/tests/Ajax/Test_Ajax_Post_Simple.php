...
use PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\Ajax\Ajax_Post_Simple;
class Test_Ajax_Post_Simple extends \PC_Headless_Blog_1AA\Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    /**
    ...
    protected function set_up()
    {
        ...
        // Body stream
        $stream = $http->stream_from_scalar(array('nonce' => wp_create_nonce('ajax_post_simple'), 'ajax_post_simple_data' => 'Test_Ajax_Post_Simple'));
        // Request
        $request = $http->request_from_globals()->withBody($stream);
        self::$ajax_instance = new \PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\Ajax\Ajax_Post_Simple($request);
