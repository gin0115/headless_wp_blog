...
use PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT;
class Test_MetaBox_CPT extends \WP_UnitTestCase
{
    ...
    public function setUp() : void
    {
        ...
        if (!$this->cpt) {
            ...
            $this->cpt = new \PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT();
            ...
            // Build inspector.
            $this->meta_box_inspector = \PC_Headless_Blog_1AA\Gin0115\WPUnit_Helpers\WP\Meta_Box_Inspector::initialise();
        }
    }
    /**
    ...
    public function test_normal_metabox_registered() : void
    {
        ...
        $view_output = \PC_Headless_Blog_1AA\Gin0115\WPUnit_Helpers\Output::buffer(function () use($box) {
            $this->meta_box_inspector->render_meta_box($box, \get_post($this->factory->post->create(array('post_type' => $this->cpt->key))));
        });
    ...
    {
        $this->assertEquals('metabox_cpt', \PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\CPT\MetaBox_CPT::get_slug());
    }
}
