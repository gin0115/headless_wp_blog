...
class Test_Basic_Tag_Taxonomy extends \PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Taxonomies\Base_Taxonomy_Runner
{
    protected $taxonomy_class = \PC_Headless_Blog_1AA\PinkCrab\Registerables\Tests\Fixtures\Taxonomies\Basic_Tag_Taxonomy::class;
    protected $post_types = array('basic_cpt');
    protected $settings = array('name' => 'basic_tag_tax', 'label' => 'Basic Tag Taxonomies', 'description' => 'The Basic Tag Taxonomy.', 'public' => \true, 'publicly_queryable' => \true, 'hierarchical' => \false, 'show_ui' => \true, 'show_in_menu' => \true, 'show_in_nav_menus' => \true, 'show_tagcloud' => \false, 'show_in_quick_edit' => \true, 'show_admin_column' => \true, 'rewrite' => 'basic_tag_tax', 'query_var' => \false, 'update_count_callback' => null, 'show_in_rest' => \false, 'rest_base' => 'basic_tag_tax', 'rest_controller_class' => 'WP_REST_Terms_Controller', 'default_term' => null);
